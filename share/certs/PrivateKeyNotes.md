...
unlocked to sign the Boostcoin-Qt.app bundle.
...
allowing somebody to distribute a Boostcoin-Qt.app or boostcoin-qt-setup.exe with a valid
...
that the boostcoin-qt.exe file inside the installer had not been tampered with.
