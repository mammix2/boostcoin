...
We recommend that everybody running prior versions of boostcoind/boostcoin-qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/mammix2/boostcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/mammix2/boostcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the boostcoin-qt package:
  sudo apt-get install boostcoin-qt
...
Code:
/Applications/Boostcoin-Qt
(on Mac) or
Code:
boostcoind/boostcoin-qt
(on Linux).
...
* (Windows only): enable ASLR and DEP for boostcoin-qt.exe
* (Windows only): add meta-data to boostcoin-qt.exe (e.g. description)
