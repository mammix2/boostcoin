...
Fix Boostcoin-Qt notifications under Growl 1.3.
Increase required age of Boostcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Boostcoin-Qt over it. (Windows)
