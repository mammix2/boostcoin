Boostcoin-Qt version 0.8.6 final is now available from:
...
/Applications/Boostcoin-Qt (on Mac) or boostcoind/boostcoin-qt (on Linux).
...
- Fix Boostcoin-Qt startup crash when clicking dock icon on OSX 
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/mammix2/boostcoin.org/pull/279).
