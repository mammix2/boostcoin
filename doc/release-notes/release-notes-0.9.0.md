...
over /Applications/Boostcoin-Qt (on Mac) or boostcoind/boostcoin-qt (on Linux).
...
Using the standard "./autogen.sh; ./configure; make" to build Boostcoin-Qt and
...
- OS X: Fix boostcoin-qt startup crash when clicking dock icon
