...
In order to support loading of multiple wallets in boostcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to boostcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into boostcoin-qt, and as such, will require some minor modifications to provide hooks for
