...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&SEND COINS"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a boostcoin address"));
    ...
    receiveCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/receiving_addresses"), tr("&RECEIVE COINS"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and boostcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your boostcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified boostcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a boostcoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible boostcoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("boostcoin"); // default title
...
void BitcoinGUI::updateStakingStatus()
{
    ...
    if(walletFrame){
        ...
        else if (nLastCoinStakeSearchInterval && nWeight)
        {
            ...
            labelStakingIcon->setToolTip(tr("Staking.<br>Your weight is %1<br>Network weight is %2").arg(nWeight).arg(nNetworkWeight).arg(text));
        }
        else
        {
