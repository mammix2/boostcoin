 ...
 * between bitcoind, and boostcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mammix2/boostcoin>";
    const std::string URL_WEBSITE = "<https://www.myboost.io/>";
