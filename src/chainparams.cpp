...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("boostcoin.net", "ns1.boostcoin.net", false));
        vSeeds.push_back(CDNSSeedData("boostcoin.net", "ns2.boostcoin.net", false));
        vSeeds.push_back(CDNSSeedData("boostcoin.net", "ns3.boostcoin.net", false));
        vSeeds.push_back(CDNSSeedData("boostcoin.net", "ns4.boostcoin.net", false));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1513162810, 1151028, 0x1e0fffff, 1);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000ff21795d443a2b3b40796adaa7b2e9bd0938ac1b5d0bec1741fc80e773c"));
        assert(genesis.hashMerkleRoot == uint256S("0xfa70e716bdfdd58e4f495bca29df9f4c83c645e6290d31c15aa9e8b2563bd600"));
