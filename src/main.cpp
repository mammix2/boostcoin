...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    if (pindexPrev->nHeight + 1 >35000) { //m2: override previous validation due to inconsistent block versions
...
string setSubVerString(int version, string subVer) {
    switch (version) {
        ...
        case 80014:
            return "/boostcoin:legacy/";
        case 80015:
            return "/boostcoin:4.6.0/";
		case 85000:
            return "/boostcoin:5.0.0/";	
		case 85001:
            return "/boostcoin:5.0.1/";	
		case 85002:
            return "/boostcoin:5.0.2/";	
		case 85003:
                     ...
                     ++mi)
                {
                    ...
                    else if (!fMissingInputs2)
                    {
                        ...
                        if (orphanTx.wit.IsNull() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/mammix2/boost/issues/8279 for details.
                            assert(recentRejects);
